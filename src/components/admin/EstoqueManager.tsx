                            ...
                            setQuantidadeEntrada("");
                              ...
                              <DialogContent className="max-w-md">
                                ...
                                {materialParaEntrada && materialParaEntrada.id === material.id && <div className="space-y-4">
                                    ...
                                    <Button className="w-full" onClick={handleAddEntrada} disabled={isAddingEntrada}>
                          ...
                          setMatriculaReserva("");
                            ...
                            <DialogContent className="max-w-md">
                              ...
                              {reservandoFerramenta && reservandoFerramenta.id === ferramenta.id && <div className="space-y-4">
                                  ...
                                  <Button className="w-full" variant={ferramenta.reserva ? "destructive" : "default"} onClick={handleReserva} disabled={isProcessingReserva}>
