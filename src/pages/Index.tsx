        ...
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center">
              <img src="/lovable-uploads/ab346669-a4ee-4f88-84a4-3252d1b2b074.png" alt="AVB Logo" className="w-6 h-6 md:w-10 md:h-10 brightness-0 invert" />
            </div>
            <div>
              <h1 className="text-lg md:text-2xl font-bold">AVB - Aço Verde Brasil</h1>
              <p className="text-xs md:text-sm text-primary-foreground/80 hidden sm:block">Sistema de Controle de Estoque e Ferramentas</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" className="text-primary-foreground hover:bg-primary-foreground/20" onClick={handleRefresh}>
              <RefreshCw className="w-4 h-4" />
            </Button>
            <Button variant="ghost" size="sm" className="text-primary-foreground hover:bg-primary-foreground/20" onClick={() => navigate("/admin")}>
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20">
            <CardContent className="p-0">
              <Button variant="ghost" className="w-full h-20 md:h-28 flex items-center justify-start gap-4 md:gap-6 text-left p-4 md:p-8 hover:bg-primary/5" onClick={() => navigate("/pegar-item")}>
          ...
          <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border-2 hover:border-accent/20">
            <CardContent className="p-0">
              <Button variant="ghost" className="w-full h-20 md:h-28 flex items-center justify-start gap-4 md:gap-6 text-left p-4 md:p-8 hover:bg-accent/5" onClick={() => navigate("/devolver-item")}>
          ...
          <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border-2 hover:border-secondary/20">
            <CardContent className="p-0">
              <Button variant="ghost" className="w-full h-20 md:h-28 flex items-center justify-start gap-4 md:gap-6 text-left p-4 md:p-8 hover:bg-secondary/5" onClick={() => navigate("/relatorios")}>
